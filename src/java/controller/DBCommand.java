...
public class DBCommand {
    ...
    public static String URL = "jdbc:mysql://rd.promptnow.com:3306/trainee";
    public static String USER = "trainee";
    public static String PASSWORD = "trainee2016";
    ...
    public int getCount(String username, String pass) throws SQLException {
        String query = "SELECT COUNT(*) FROM admin WHERE admin_username = '" + username + "' AND admin_password = '" + pass + "'";
    ...
    public ModelAdmin setAdmin(String username, String pass) throws SQLException {
    ...
    public ModelHistory[] sethistory(int n, String date1, String date2) {
        ModelHistory[] a = new ModelHistory[n];
    ...
    public ModelDevice[] setdevice(int n, String series) {
        ModelDevice[] a = new ModelDevice[n];
    ...
    public String[] getData(ModelAdmin a) throws SQLException {
        int n = 0, j = 0;
    ...
    public String[] gethistoryData(int i, ModelHistory[] a) throws SQLException {
        int all = i * 6;
        int n = 0, j = 0;
    ...
    public String[] getdeviceData(int i, ModelDevice[] a) throws SQLException {
        int all = i * 14;
        int n = 0, j = 0;
        String data[] = new String[all];
