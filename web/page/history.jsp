...
<html>
    ...
    <body>
        ...
        <div class="container">
            <c:choose>
                <c:when test="${sessionScope.history != null}">
                    <% 
                        String[] data = (String[]) session.getAttribute("history");
                        int row = data.length;
                        int record = row/6;
                        int i=0;
                    %>
              ...
              out.print("</tr>");
                    ...
                    <center><a href="clear/clearhistory.jsp"><span class="glyphicon glyphicon-off"></span>ดูวันอื่นๆ</a></center>
                </c:when>
                <c:otherwise>
                    <legend><h2>Search history list</h2></legend>
                    <c:if test="${sessionScope.data == 0 && sessionScope.data != null}">
